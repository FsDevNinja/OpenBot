...
- [Local Codex provider](../agent-codex/README.md): persistent Codex threads through OpenBot's governed tool gateway, using the ChatGPT account already signed in on the host.
