      ...
      <PageSection
        description={
          <>
            ...
            <code>mcp.tool</code>, <code>mcp.effect</code> and{" "}
            <code>mcp.operation</code> for a call to somebody else&rsquo;s
            tools. A rule that cannot be evaluated counts as a match, so a
            mistyped deny refuses rather than quietly permitting what it was
            meant to forbid.
          </>
        }
        title="It may never"
